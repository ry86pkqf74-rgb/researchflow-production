 ...
 */
export function validateWordBudget(content, section, customBudgets) {
 ...
 */
export function validateManuscript(sections, customBudgets) {
    const results = {};
 ...
 */
export function getTotalWordCount(sections) {
 ...
 */
export function isWithinJournalLimits(sections, minTotal = 3000, maxTotal = 5000) {
...
//# sourceMappingURL=word-budget.js.map