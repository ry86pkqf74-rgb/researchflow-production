...
export class RegexPhiScanner {
    ...
    scan(text) {
        ...
        for (const patternDef of PHI_PATTERNS) {
            ...
            while ((match = patternDef.regex.exec(text)) !== null) {
                const confidence = this.calculateConfidence(patternDef.baseConfidence, match[0]);
                findings.push({
     ...
     */
    calculateConfidence(baseConfidence, matchedText) {
...
//# sourceMappingURL=regex-scanner.js.map